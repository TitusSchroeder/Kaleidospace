...
import { Heart, Calendar, Users, Lock, ShieldCheck, Plus, ChevronRight, ArrowLeft, MessageSquare, HelpCircle, Star, Sparkles, Building2, Trash2 } from 'lucide-react';
import { PhaseSchatullen } from '../PhaseSchatullen';

export const ExperienceSpace = ({ memories = [], phases = [], simulatedDate, onDeleteMemory, onOpenCreator }) => {
  const [subView, setSubView] = useState('overview'); // 'overview', 'moments', 'events', 'family', 'private', 'partner'
    ...
    <div className="w-full space-y-4 select-none pb-20">
      ...
      <div className="p-4 bg-red-600 text-white rounded-3xl border-2 border-red-700 shadow-md">
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="text-[10px] font-mono font-bold uppercase tracking-wider bg-red-700 px-2.5 py-0.5 rounded-full">
              Space 1
            </span>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-500 font-serif">5 Schatullen & Lebenschronik</p>
              </div>
            </div>
      ...
      {/* SUB-VIEW 1: MOMENTE & ERINNERUNGEN */}
      {subView === 'moments' && (
        <div className="space-y-3">
          <button
          ...
          >
            ...
            <span>Zurück zum Experience Space</span>
          </button>
      ...
      {/* SUB-VIEW 3: FAMILIE UND FREUNDE */}
      {subView === 'family' && (
        <div className="space-y-3">
          <button
            onClick={() => setSubView('overview')}
